...
// Problem: Crucial Equation
// Contest: SPOJ - Classical
// URL: https://www.spoj.com/problems/CEQU/
// Memory Limit: 1536 MB
// Time Limit: 3000 ms
// Problem tag: number theory, LDE
// TC:
// SC:
...
{
	ll a,b,c; cin>>a>>b>>c;
	if (a==0 && b==0)	// degenerate case
	{
		if (c==0) cout<<"Yes";
		else cout<<"No";
		return;
	}
	// use extended euclidean equation to find result of ax+by=gcd(a,b)
	// if c is divisible by gcd(a,b), then integer solution exists else no integer solution
	ll g=gcd(a,b);
	if (c%g==0) cout<<"Yes";
	else cout<<"No";
}
